...
def download_files(music):
    ...
    download.download_files([f"{music}.mp3", 'bg.png', 'font_kl.ttf', 'output_image.png'])
...
def create_image_and_video(music):
    ...
    with open("quote_data.json", "r", encoding="utf-8") as quote_data:
        ...
        image = TextImageGenerator('bg.png', 'font_kl.ttf', 'output_image.png')
...
def upload_to_s3():
    ...
    url = s3.upload_file_to_s3('output_video.mp4', 'output_video_kl.mp4')
    return url
